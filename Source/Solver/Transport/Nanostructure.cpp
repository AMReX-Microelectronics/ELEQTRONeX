...
template <typename NSType>
amrex::Real c_Nanostructure<NSType, true>::Compute_CellVolume()
{
...
template <typename NSType>
void c_Nanostructure<NSType, true>::Fill_AtomLocations()
{
...
template <typename NSType>
void c_Nanostructure<NSType, true>::Evaluate_LocalFieldSites()
{
    int lev = 0;
...
template <typename NSType>
void c_Nanostructure<NSType, true>::Read_AtomLocations()
{
    if (ParallelDescriptor::IOProcessor())
    {
...
template <typename NSType>
void c_Nanostructure<NSType, true>::Mark_CellsWithAtoms()
{
    auto &rCode = c_Code::GetInstance();
...
template <typename NSType>
void c_Nanostructure<NSType, true>::Gather_PotentialAtAtoms()
{
    const auto &plo = _geom->ProbLoArray();
    const auto dx = _geom->CellSizeArray();
...
template <typename NSType>
void c_Nanostructure<NSType, true>::Deposit_ZeroToMesh()
{
    const auto &plo = _geom->ProbLoArray();
    const auto dx = _geom->CellSizeArray();
    int lev = 0;
...
template <typename NSType>
void c_Nanostructure<NSType, true>::Deposit_ChargeDensityToMesh()
{
    const auto &plo = _geom->ProbLoArray();
    const auto dx = _geom->CellSizeArray();
    int lev = 0;
...
template <typename NSType>
void c_Nanostructure<NSType, true>::Obtain_PotentialAtSites()
{
